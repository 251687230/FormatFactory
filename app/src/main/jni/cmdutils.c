...
void init_opts(void)
{
    av_dict_set(&sws_dict, "flags", "bicubic", 0,0);
}
...
int opt_default(void *optctx, const char *opt, const char *arg)
{
    ...
    if ((o = opt_find(&cc, opt_stripped, NULL, 0,
        ...
        av_dict_set(&codec_opts, opt, arg, FLAGS,0);
        consumed = 1;
    }
    if ((o = opt_find(&fc, opt, NULL, 0,
                         AV_OPT_SEARCH_CHILDREN | AV_OPT_SEARCH_FAKE_OBJ))) {
        av_dict_set(&format_opts, opt, arg, FLAGS,0);
        if (consumed)
    ...
    if (!consumed && (o = opt_find(&sc, opt, NULL, 0,
        ...
        av_dict_set(&sws_dict, opt, arg, FLAGS,0);
    ...
    if (!consumed && (o=opt_find(&swr_class, opt, NULL, 0,
        ...
        av_dict_set(&swr_opts, opt, arg, FLAGS,0);
        consumed = 1;
    }
#endif
#if CONFIG_AVRESAMPLE
                                ...
                                AVFormatContext *s, AVStream *st, AVCodec *codec)
{
    ...
    while (t = av_dict_get(opts, "", t, AV_DICT_IGNORE_SUFFIX)) {
        ...
        if (av_opt_find(&cc, t->key, NULL, flags, AV_OPT_SEARCH_FAKE_OBJ) ||
            ...
            av_dict_set(&ret, t->key, t->value, 0,0);
        else if (t->key[0] == prefix &&
                 av_opt_find(&cc, t->key + 1, NULL, flags,
                             AV_OPT_SEARCH_FAKE_OBJ))
            av_dict_set(&ret, t->key + 1, t->value, 0,0);
